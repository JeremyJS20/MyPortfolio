        ...
        <section className="" id="contact">
            <div className="flex flex-col items-center py-40 desktopW:py-[245px] laptop:py-52 tablet:py-48 w-[95vw] mx-auto desktop:w-[70vw] laptop:w-[85vw] laptop:container">
                <div className="flex flex-col items-center mb-12">
                    <span className="text-2xl  mb-1 desktop:text-4xl tablet:text-3xl">{t('contacto')}</span>
                    <span className="text-xs text-gray-400 dark:text-gray-500  mb-5 laptop:text-base">{t('ponte-en-contacto')}</span>
                </div>

                <div className="flex flex-col gap-10 w-[90%] laptop:w-[80%] tablet:w-[70%] laptop:flex-row">
                            ...
                            infoData.map(i => (
                                <div key={i.key} className='flex items-center mb-10'>
                                    ...
                                    <div className='flex flex-col'>
                                        ...
                                        <span className='text-xs text-gray-500 desktop:text-base laptop:text-sm'>{`${i.text === 'ubicacion'? t('pais'):''}${i.value}`}</span>
                                    </div>
                                </div>
                            ))
                        }
                    ...
                    <div className='mt-0 tablet:mt-0 laptop:w-[45%]'>
                        ...
                        <form onSubmit={handleOnSubmit}>
                            ...
                            <button type="submit" className="bg-green-700 text-gray-100 mt-7 rounded-xl ! cursor-pointer text-center p-6 hover:bg-green-600 focus:!ring-transparent w-[50%] desktopW:w-[40%] laptop:w-[60%] tablet:w-[35%]">{t('enviar')}</button>
                        </form>
                    </div>
                </div>
            </div>
